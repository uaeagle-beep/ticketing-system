...
public static class ErrorStatusMap
{
    public static int ToHttpStatus(ServiceErrorCode code) => code switch
    {
        ...
        ServiceErrorCode.InsufficientScope => StatusCodes.Status403Forbidden,
        ServiceErrorCode.AccountBlocked => StatusCodes.Status401Unauthorized,
        ServiceErrorCode.NotFound => StatusCodes.Status404NotFound,
        ServiceErrorCode.PayloadTooLarge => StatusCodes.Status413PayloadTooLarge,
        ServiceErrorCode.UnsupportedMediaType => StatusCodes.Status415UnsupportedMediaType,
