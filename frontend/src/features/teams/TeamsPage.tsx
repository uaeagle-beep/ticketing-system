...
import { WebhooksManager } from '@/features/integrations/WebhooksManager';
...
export function TeamsPage() {
  ...
  const [webhooksTeamId, setWebhooksTeamId] = useState<string | null>(null);
  ...
  const renameMutation = useMutation({
    ...
    onSuccess: () => {
      toast.showSuccess(t('toast.renamed'));
      setEditingId(null);
      setEditingName('');
      invalidate();
    },
  ...
  const wipMutation = useMutation({
    ...
    onSuccess: (_team, { id }) => {
      toast.showSuccess(t('toast.wipSaved'));
      setWipTeamId(null);
      invalidate();
  ...
  return (
    <div className="page-container">
      ...
      <p className="page-note">
        {isAdmin ? t('note.admin') : t('note.member')}
      </p>
      ...
      {teamsQuery.isLoading ? (
        ...
        <EmptyState
          title={t('empty.title')}
          message={isAdmin ? t('empty.adminMessage') : t('empty.memberMessage')}
          action={
            isAdmin ? (
        ...
        <table className="data-table">
          ...
          <tbody>
            {teams.map((team) => {
              ...
              const isWebhooksOpen = webhooksTeamId === team.id;
              return (
                  ...
                  <td>
                    <div className="table-actions">
                      ...
                      <button
                        ...
                        onClick={() => setWebhooksTeamId((cur) => (cur === team.id ? null : team.id))}
                      >
                        {t('actions.webhooks')}
                      </button>
                      {isAdmin ? (
                        <button
                          ...
                          title={hasChildren ? t('deleteHint') : undefined}
