...
Main navigation: **Board · Teams · Epics · Analytics · Notifications** (and **Users** for admins).
On the right of the header: the notifications bell, the language switcher, and the profile menu.
